...
EXPERIMENT_VARIABLES_LABELS = ["Tiempo Pre VAM", "Tiempo VAM", "Tiempo Post VAM", "Estadia UCI", "Estadia Post UCI"]


EXPERIMENT_VARIABLES_LABELS_DATAFRAME = EXPERIMENT_VARIABLES_LABELS + ["Promedio Predicción"]
